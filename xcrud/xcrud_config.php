...
{
    // default connection
    public static $dbname = 'careerat'; // Your database name
    public static $dbuser = 'root'; // Your database username
    public static $dbpass = '111111'; // // Your database password
    ...
    // editor
    public static $editor_url = 'asset/xcrud/editors/tinymce/tinymce.min.js'; // URL path to editor script, if you want to use the visual editor.
    ...
    public static $plugins_uri = 'asset/xcrud/plugins'; // scripts and libraries
    public static $themes_uri = 'asset/xcrud/themes'; // css, images
    public static $lang_uri = 'asset/xcrud/languages'; // js files
